...
class Configuration(object):
    """ Stores configuration variables and functions for Wifireconn. """
    ...
    def parse_wpa_args(cls, args):
        ...
        if args.wordlist:
            if not os.path.exists(args.wordlist):
                cls.wordlist = None
                Color.pl('{+} {C}option:{O} wordlist {R}%s{O} was not found, wifireconn will NOT attempt to crack '
                ...
                cls.wordlist = None
                Color.pl('{+} {C}option:{O} wordlist {R}%s{O} is a directory, not a file. wifireconn will NOT attempt to '
